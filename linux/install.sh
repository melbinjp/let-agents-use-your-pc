...
# - Stop and disable the 'cloudflared' service.
...
# Check for a running SSH server
if ! systemctl is-active --quiet ssh; then
    error "The SSH server (sshd) is not running. Please enable and start it before running this script."
fi
info "Verified that the SSH server is active."
